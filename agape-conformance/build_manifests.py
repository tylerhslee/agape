#!/usr/bin/env python3
"""
Agape v1.0.0-alpha.2026.7.2.2 conformance suite — manifest builder.
...
def render_toml(tests):
    L = ["# Agape v1.0.0-alpha.2026.7.2.2 conformance manifest (generated by build_manifests.py from the .ag headers).",
...
def render_md(tests):
    ...
    md = ["# Agape v1.0.0-alpha.2026.7.2.2 — Conformance Test Index\n",
