#!/usr/bin/env python3
"""
Agape v1.0.0-beta.2026.8.6.0 conformance suite — manifest builder.
...
def render_toml(tests):
    L = ["# Agape v1.0.0-beta.2026.8.6.0 conformance manifest (generated by build_manifests.py from the .ag headers).",
...
def render_md(tests):
    ...
    md = ["# Agape v1.0.0-beta.2026.8.6.0 — Conformance Test Index\n",
