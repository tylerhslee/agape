...
Target spec: `../SPEC.md` `v1.0.0-alpha.2026.7.11.7` — the core kernel.
...
- Language suite: `.ag` accept/reject tests under `tests/` — currently `207` tests (`128` accept, `79` reject), including `06b_world` (the wired events/actions world interface) and `06c_delegation` (the §6c task-send).
