...
function reflectionPrompt(episode: string): string {
  return [
    ...
    "Attribute everything to the right person: you are the agent, and facts others state about themselves belong to them, not to you (write \"the user uses …\", not \"I use …\").",
    "Refer to people only by names that appear in the raw episode itself; if the episode never names someone, call them \"the user\" — never invent or assume a name.",
